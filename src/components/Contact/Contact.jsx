    ...
    return (
        <div className='section-container'>
            ...
            <div className='social-icons-container'>
                <a href='https://github.com/anmolbansal7' className='social-icon'>
                    <img src={github} alt='social' />
                </a>
                <a
                    href='https://linkedin.com/in/anmolbansal7'
                    className='social-icon'
                >
                    <img src={linkedin} alt='social' />
                </a>
                <a
                    href='https://instagram.com/anmollbansall'
                    className='social-icon'
                >
                    <img src={instagram} alt='social' />
                </a>
                <a
                    href='https://medium.com/@anmolbansal7'
                    className='social-icon'
                >
